...
int main()
{
    ...
    // -------------------------
    Shader lightingShader("../shaders/3.3.lighting_maps.vs", "../shaders/3.3.multi_light.fs");
    Shader lightCubeShader("../shaders/3.3.light_cube.vs", "../shaders/3.3.light_cube_materials.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("dirLight.ambient", dirColor * 0.1f);
        lightingShader.setVec3("dirLight.diffuse", dirColor * 0.2f);
        lightingShader.setVec3("dirLight.specular", dirColor * 0.5f);
